...
CRITICAL_FILES = [
    ...
    "solutions.html",
    "robots.txt",
    "assets/css/evidence-fondateur.css",
    "assets/css/style.css",
    "assets/js/actualites.js",
    "assets/js/automation.js",
    "assets/js/evidence-fondateur.js",
    "assets/js/main.js",
    "assets/js/mediatheque.js",
    "assets/js/qualifier.js",
    "assets/data/oby-preuves-selectionnees.json",
    ...
    "quality/media-provenance-oby-bluewave.json",
    "quality/sources-candidates-afrique-ouest.md",
    "quality/scripts/build_dist.py",
    "quality/scripts/build_evidence_fondateur.py",
